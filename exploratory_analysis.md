...
This representation maintains the SQL code structure and separates each query, providing readability and clarity for each part of the script. If you have any further questions or need additional assistance, feel free to ask!olocation_state
    END;
```
